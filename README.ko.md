...
이 플러그인은 두 개의 Skill을 설치하고, 다음의 공개 읽기 전용 MCP 게이트웨이
한 개에 연결합니다.
...
18개의 읽기 전용 도구는 `io-mcp`, `oda-map-lab`, `devcoop-kg`,
...
전체 플러그인은 번들로 제공되는 두 개의 Skill과 등록된 `ODA Intelligence`
